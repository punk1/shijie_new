...
//           final DynamicItem dynamicItem = new DynamicItem();
           ...
           history.setP_dynasty(mPoemBean.getP_source());
//           //  shan 2
...
//           });
    ...
    public   void initView() {
         ...
         iv_play = findViewById(R.id.iv_paly);
    }
...
//            tv_play.setText(getResources().getString(R.string.pause_text));
            iv_play.setImageDrawable(getResources().getDrawable(R.drawable.ic_bofang));
...
//            tv_play.setText(getResources().getString(R.string.play_text));
            iv_play.setImageDrawable(getResources().getDrawable(R.drawable.ic_bofang1));
...
//                tv_play.setText(getResources().getString(R.string.replay_text));
    ...
    public void onAlbumLoaded(Poetry album) {
        ...
        Typeface typeface = Typeface.createFromAsset(getAssets(),"3.ttf");
        tv_poem_content.setTypeface(typeface);
        tv_poem_title.setTypeface(typeface);
        tv_title.setTypeface(typeface);
        tv_poem_author.setTypeface(typeface);
        tv_poem_year.setTypeface(typeface);
