...
public class Albumlitadapter extends RecyclerView.Adapter<Albumlitadapter.InnerHoler>{
    ...
    @NonNull
    @Override
    public Albumlitadapter.InnerHoler onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Albumlitadapter.InnerHoler innerHoler, int i) {
        // 设置数据
